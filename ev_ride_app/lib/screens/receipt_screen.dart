...
class ReceiptScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateStr =
        (dateRaw as String).length >= 10 ? dateRaw.substring(0, 10) : '—';
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(children: [
                  ...
                  Text('Paid via ${payment.toUpperCase()}',
                      style: TextStyle(
              ...
              _card(children: [
                ...
                _routeRow(Icons.location_on_rounded, const Color(0xFFEF4444),
                    'Drop-off', dropoff),
              ]),
              ...
              Container(
                ...
                child: const Row(children: [
                  ...
                  Expanded(
                      child: Text(
                          'This trip was completed in a 100% Electric Vehicle. Thank you for riding green!',
                          style: TextStyle(
  ...
  Widget _routeRow(IconData icon, Color color, String label, String val) =>
      Row(children: [
